package com.workzen.ems.config;

import com.workzen.ems.service.CustomUserDetailsService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                // Allow ALL OPTIONS preflight requests — must come before any auth check
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // which setAllowedOrigins does NOT — required for Vercel preview deployments
